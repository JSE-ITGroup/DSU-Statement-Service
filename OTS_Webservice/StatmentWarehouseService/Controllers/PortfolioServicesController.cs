...
namespace StatmentWarehouseService.Controllers
{
   //[Route("Jse/PortfolioServices")]
    public class PortfolioServicesController : ApiController
    {
        ...
        [Route("Jse/PortfolioServices/GetPortfolio/{AccountNumber}/{StartDate}/{EndDate}/{Token}")]
        ...
        [Route("Jse/PortfolioServices/PortfolioDownload/{AccountNumber}/{StartDate}/{EndDate}/{Token}/{Token2}")]
